...
<head>
  ...
  <title>404 Not Found - Bandes Rekayasa Digital</title>
  ...
  <main>
    <div class="container">
      ...
      <section class="section error-404 min-vh-100 d-flex flex-column align-items-center justify-content-center">
        ...
        <a class="btn" href="<?= base_url('dashboard/dashboard'); ?>">Back to home</a>
        <img src="<?= base_url(); ?>assets/dashboard/img/not-found.svg" class="img-fluid py-5" alt="Page Not Found" width="100px" height="100px">
        <div class="credits">
